...
(function () {
  ...
  const translations = {
    es: {
      ...
      "hero.description": "Un enclave residencial exclusivo y de alta plusvalía. Lotes con topografía 100% regular a <strong>175 metros de la carretera internacional</strong> y a solo <strong>4 cuadras del Parque Central</strong>.",
      ...
      "concept.subtitle": "Empoderamos su inversión con infraestructura de vanguardia, privacidad y una ubicación de insuperable plusvalía en el corazón de Copán Ruinas.",
      ...
      "concept.c4_title": "Privacidad & Entorno Exclusivo",
      "concept.c4_desc": "Muro perimetral cerrado, diseño urbanístico ordenado y una comunidad residencial privada.",
      "concept.c5_title": "Servicios Básicos & Conectividad",
      "concept.c5_desc": "Redes completas de agua potable, energía eléctrica y telecomunicaciones de alta calidad.",
      ...
      "trust.c4_title": "Alta Plusvalía",
      "trust.c4_desc": "Ubicación estratégica y desarrollo urbanístico que garantizan el crecimiento continuo de su inversión.",
    ...
    en: {
      ...
      "hero.description": "An exclusive, high-equity residential development. 100% flat topography lots <strong>175 meters from the international highway</strong> and just <strong>4 blocks from Central Park</strong>.",
      ...
      "concept.subtitle": "We empower your investment with state-of-the-art infrastructure, privacy, and an unbeatable prime location in Copán Ruinas.",
      ...
      "concept.c4_title": "Privacy & Exclusive Setting",
      "concept.c4_desc": "Gated perimeter wall, orderly urban design, and a private residential community.",
      "concept.c5_title": "Utilities & Connectivity",
      "concept.c5_desc": "Complete potable water supply, electrical grid, and modern telecom infrastructure.",
      ...
      "trust.c4_title": "High Property Equity",
      "trust.c4_desc": "Strategic location and urban development ensuring continuous property equity growth.",
  ...
  const blockData = {
    es: {
      A: {
        ...
        title: 'Sector Norte & Vistas Altas (Lotes 1 al 7)',
        desc: 'Ubicado en el sector norte del desarrollo, comprende los lotes del 1 al 7 con vistas panorámicas despejadas a las cordilleras de Copán. Entorno de máxima privacidad, estrictamente residencial y libre de ruidos.',
        use: '100% Residencial',
        topo: 'Regular / Suave Elevación',
        price: '$250 / v²',
        fin: 'Gestión Directa con Asesor',
        features: [
          '7 lotes residenciales en la zona norte más elevada',
          'Vistas panorámicas hacia el atardecer y montañas',
          'Muro perimetral y entorno residencial privado',
      ...
      B: {
        ...
        desc: 'Ubicado en la zona central del desarrollo, comprende los lotes del 1 al 5 con acceso directo a calles peatonales arboladas y áreas verdes protegidas. Topografía 100% plana para residencias de alto nivel.',
        use: '100% Residencial',
        topo: 'Regular / Plana',
        price: '$250 / v²',
        fin: 'Gestión Directa con Asesor',
        features: [
          ...
          'Conexión de agua y energía eléctrica en cada lote',
      ...
      C: {
        ...
        title: 'Sector Sur & Zona Mixta (Lotes 1 al 4)',
        desc: 'Estratégicamente posicionado en el sector sur sobre la avenida principal de acceso, comprende los lotes del 1 al 4 para proyectos comerciales selectos de baja densidad (cafés boutique, consultorios, galerías) o residencias con vocación mixta.',
        use: 'Residencial / Comercial Selecto',
        topo: 'Regular / Plana',
        price: '$250 / v²',
        fin: 'Gestión Directa con Asesor',
        features: [
          '4 lotes con frente a la avenida de acceso',
    ...
    en: {
      A: {
        ...
        title: 'North Sector & High Views (Lots 1 to 7)',
        desc: 'Located in the northern sector of the development, encompassing lots 1 through 7 with unobstructed panoramic mountain views. Maximum privacy, strictly residential and free from traffic noise.',
        use: '100% Residential',
        topo: 'Regular / Gentle Elevation',
        price: '$250 / v²',
        fin: 'Direct Sales Advisor',
        features: [
          '7 residential lots in the elevated north sector',
          'Panoramic views towards sunsets and mountain ridges',
          'Gated perimeter wall and private residential setting',
      ...
      B: {
        ...
        desc: 'Situated in the serene heart of the community, encompassing lots 1 through 5 with direct access to tree-lined pedestrian avenues and protected green areas. 100% flat topography for family residences.',
        use: '100% Residential',
        topo: 'Regular / Flat',
        price: '$250 / v²',
        fin: 'Direct Sales Advisor',
        features: [
          ...
          'Water and electrical power connection on every lot',
      ...
      C: {
        ...
        title: 'South Sector & Mixed-Use (Lots 1 to 4)',
        desc: 'Strategically positioned in the southern sector along the main access boulevard, encompassing lots 1 through 4 to accommodate select low-density commercial ventures or mixed-use residences.',
        use: 'Residential / Select Commercial',
        topo: 'Regular / Flat',
        price: '$250 / v²',
        fin: 'Direct Sales Advisor',
        features: [
          '4 lots facing the main access boulevard',
